...
#define RCC_CFGR			*((volatile u32*)(RCC_BASE_ADDRESS + 0x04))//Processor clock
...
#define RCC_AHBENR			*((volatile u32*)(RCC_BASE_ADDRESS + 0x14))//Enable and disable peripheral
#define RCC_APB2ENR			*((volatile u32*)(RCC_BASE_ADDRESS + 0x18))//Enable and disable peripheral
#define RCC_APB1ENR			*((volatile u32*)(RCC_BASE_ADDRESS + 0x1C))//Enable and disable peripheral
